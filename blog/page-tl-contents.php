        ...
        <div class="content">
            <div class="container content__container">
                <main id="category-main" class="category-main">
                        ...
                        <section id="ranking" class="ranking">
                            <div class="ranking-inner">
                                ...
                                <ul class="blog-list">
                                    <?php
                                    $args = array(
                                        "category__in" => array(669), // カテゴリID408のみを含む
                                        "post_type"             => "post",
                                        "post_status"          => "publish",
                                        "posts_per_page"        => 5,
                                        "orderby"               => "post_views",
                            ...
                            <div class="all-post">
                                <a href="/tl-ranking/">ランキングをもっと見る</a>
                            </div>
                        </section>
                    ...
                    <!-- ページネーションを表示 -->
                    <div class="all-post">
                        <a href="/?cat=669">TL作品の新着記事をもっと見る</a>
                    </div>
                        ...
                        <div class="category-inner">
                            ...
                            <div id="tag" class="category-inner">
                                ...
                                <div class="all-categoly">
                                    ...
                                    echo '<a href="' . esc_url($permalink) . '">TL作品タグ一覧</a>';
                                    ?>
                                </div>
                            </div>
                    </section>
